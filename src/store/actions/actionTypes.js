...
export const SUBMIT_PERSONAL_DATA = 'SUBMIT_PERSONAL_DATA';
export const SUBMIT_PERSONAL_DATA_START = 'SUBMIT_PERSONAL_DATA_START';
export const SUBMIT_PERSONAL_DATA_SUCCESS = 'SUBMIT_PERSONAL_DATA_SUCCESS';
export const SUBMIT_PERSONAL_DATA_FAIL = 'SUBMIT_PERSONAL_DATA_FAIL';
export const SUBMIT_PERSONAL_DATA_INIT = 'SUBMIT_PERSONAL_DATA_INIT';

export const FETCH_PERSONAL_DATA = 'FETCH_PERSONAL_DATA';
export const FETCH_PERSONAL_DATA_START = 'FETCH_PERSONAL_DATA_START';
